...
# 📌 Website with Dinamic Image

Site modelo slide pra demonstrar o uso do `JavaScript`.
...
```bash
  git clone https://link-para-o-projetohttps://github.com/veras-dan/website-with-dinamic-image
```

Entre no diretório do projeto:

```bash
  cd website-with-dinamic-image
```
